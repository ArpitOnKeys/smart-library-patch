  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-destructive/90 text-destructive-foreground hover:bg-destructive backdrop-blur-sm border border-destructive/20",
        outline:
          "border border-border/30 bg-card/60 hover:bg-card/80 hover:text-accent-foreground backdrop-blur-xl",
        secondary:
          "bg-secondary/80 text-secondary-foreground hover:bg-secondary/90 backdrop-blur-sm border border-border/20",
